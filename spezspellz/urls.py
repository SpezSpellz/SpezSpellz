...
from .views import HomePage, UploadPage, TagsPage, profile_view, spell_detail, thumbnail_view, RegisterView, attachment_view, UserSettingsPage, review_view
...
urlpatterns = [
    ...
    path("review/<int:spell_id>/", review_view, name="review")
]
